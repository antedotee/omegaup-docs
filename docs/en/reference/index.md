...
|-----------|-------------|
| [Glossary](glossary.md) | Terminology and definitions used in omegaUp |
| [Supported Languages](languages.md) | Programming languages and their configurations |
| [Useful Links](links.md) | External resources and documentation |

## Glossary

The [Glossary](glossary.md) covers:
...
The [Languages](languages.md) reference includes:
...
The [Links](links.md) page provides:
