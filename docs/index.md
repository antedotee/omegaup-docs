...
-   :material-api:{ .lg .middle } __[API Reference](api/index.md)__
...
### :material-api:{ .lg } [API Reference](api/index.md)
...
- **Contribute Code**: See our [Contributing Guide](getting-started/contributing.md)
- **Report Issues**: Visit our [GitHub Issues](https://github.com/omegaup/omegaup/issues)
- **Join Discussions**: Participate in our community discussions
- **Google Summer of Code**: Check out our [GSoC program](community/gsoc/index.md)
...
**Ready to start?** Head to [Getting Started](getting-started/index.md) to set up your development environment!
